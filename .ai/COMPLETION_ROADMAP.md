...
- Phases A + B + C + D **complete** (D3/D4 in `9ae3c33`, D1 in `af5b401`, D2 in `132b873`). F-series: **F1 (async queue, `5afca4d`), F2 (correlation, `46310fb` + wiring fix `b260b55`), F3 (retention, `ccf62a8`) done**; F4 (RBAC/audit) next, then F5–F8.
